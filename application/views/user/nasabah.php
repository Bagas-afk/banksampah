                    ...
                    foreach ($data_nasabah as $nasabah) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } else { ?>
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#infoModal<?= $nasabah->id ?>"><i class="fas fa-info-circle"></i></button>
                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editModal<?= $nasabah->id ?>"><i class="fas fa-edit"></i></button>
                                    <button type=" button" class="btn btn-danger" data-toggle="modal" data-target="#hapusModal<?= $nasabah->id ?>"><i class="fas fa-trash"></i></button>
                                <?php } ?>
                            </td>
                        </tr>
                        <!-- Modal Verif-->
